...
def get_province_info(applicant_name):
    list = ['河北省','山西省','辽宁省','吉林省','黑龙江省','江苏省','浙江省','安徽省','福建省','江西省','山东省','河南省','湖北省','湖南省','广东省','海南省','四川省','贵州省','云南省','陕西省','甘肃省','青海省','台湾省']
...
def get_applicant_browse_history():
    lists = ['科幻='+str(random.randint(1,5))+' '+'文学='+str(random.randint(1,5))+' '+'游戏='+str(random.randint(1,5))]
